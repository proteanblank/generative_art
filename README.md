The latest & greatest is in the [ppy_terminal directory](https://github.com/aaronpenne/generative_art/tree/master/ppy_terminal). Using Processing from the termainal with Python. It's fun.
