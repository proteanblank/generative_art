...
def draw():
    ...
    helper.save_frame_timestamp('butterballs_{}_{}'.format(palette_idx, lines), timestamp, random_seed)
...
def get_angles_radii_antennae(angle_offset, r):
    ...
    angles[1] = helper.random_centered(900, angle_offset)
    angles[2] = helper.random_centered(300, angle_offset)
    angles[3] = helper.random_centered(200, angle_offset)
